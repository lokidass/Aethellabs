...
const approachSteps = [
  {
    ...
    title: "Listen First",
    description:
      "We don't walk in with ready-made solutions. We start by listening, to how your team works, where time gets lost, and what goals truly matter to you. Every automation we build begins with understanding, not assumptions.",
    isRotated: true,
  },
  {
    number: "02",
    ...
    description:
      "Once we see the full picture, we identify the gaps, those silent inefficiencies that slow things down. Then we explore how AI can quietly step in to simplify not complicate.",
    isRotated: true,
  },
  {
    number: "03",
    title: "Make It Work",
    description:
      "Then we build. Every automation is designed to fit naturally into how you already work. Simple and Practical.",
    isRotated: false,
  },
  {
    number: "04",
    ...
    description:
      "Things change, and so should your systems. We stick around to tweak, refine, and grow your automations as your team grows.",
    isRotated: true,
  },
];
...
export const OurApproachSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-[66px] pt-[74px] pb-0 px-0 w-full mt-[-155px]">
      ...
      <p className="w-full max-w-[663px] [font-family:'Inter',Helvetica] font-normal text-white text-2xl text-center tracking-[0] leading-[normal]">
        A proven methodology that ensures successful ai implementation from
        concept to deployment.
      </p>

      <div className="flex items-center justify-center gap-[47px] flex-wrap">
